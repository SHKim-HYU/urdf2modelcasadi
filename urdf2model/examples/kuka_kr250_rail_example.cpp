...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/KUKA/kuka_kr250/kuka_kr_250_rail.urdf";
  ...
  std::string ft_frame_name = "ft_sensor_joint";
  ...
  mecali::generate_code(fd, "kuka_kr_250_rail_fd", codegen_options);
  mecali::generate_code(id, "kuka_kr_250_rail_id", codegen_options);
  mecali::generate_code(M, "kuka_kr_250_rail_M", codegen_options);
  mecali::generate_code(Minv, "kuka_kr_250_rail_Minv", codegen_options);
  mecali::generate_code(C, "kuka_kr_250_rail_C", codegen_options);
  mecali::generate_code(G, "kuka_kr_250_rail_G", codegen_options);
  ...
  mecali::generate_code(fk_ft, "kuka_kr_250_rail_fk_ft", codegen_options);
  mecali::generate_code(fk_base, "kuka_kr_250_rail_fk_base", codegen_options);
