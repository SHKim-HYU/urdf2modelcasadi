...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYU/caesar/KARM_EM_v2_sat.urdf";
  ...
  std::vector<std::string> required_Frames = {"joint1", "joint2", "joint3", "joint4", "joint5", "joint6", "joint7", "RFT_fixed", "tcp_fixed"};
  ...
  mecali::generate_code(C, "indy12_v2_sat_C", codegen_options);
  mecali::generate_code(G, "indy12_v2_sat_G", codegen_options);
   mecali::generate_code(fkrot_ee, "indy12_v2_sat_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "indy12_v2_sat_fk_ee", codegen_options);
  mecali::generate_code(fk, "indy12_v2_sat_fk", codegen_options);
  mecali::generate_code(J_s, "indy12_v2_sat_J_s", codegen_options);
  mecali::generate_code(J_b, "indy12_v2_sat_J_b", codegen_options);
  mecali::generate_code(dJ_s, "indy12_v2_sat_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "indy12_v2_sat_dJ_b", codegen_options);

  robot_model.generate_json("indy12_v2_sat.json");
