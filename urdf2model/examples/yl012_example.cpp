...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HDRobotics/yl012/yl012.urdf";
  ...
  mecali::generate_code(fd, "yl012_fd", codegen_options);
  mecali::generate_code(CoM_x, "yl012_CoM_x", codegen_options);
  mecali::generate_code(id, "yl012_id", codegen_options);
  mecali::generate_code(M, "yl012_M", codegen_options);
  mecali::generate_code(Minv, "yl012_Minv", codegen_options);
  mecali::generate_code(C, "yl012_C", codegen_options);
  mecali::generate_code(G, "yl012_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "yl012_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "yl012_fk_ee", codegen_options);
  mecali::generate_code(fk, "yl012_fk", codegen_options);
  mecali::generate_code(J_fd, "yl012_J_fd", codegen_options);
  mecali::generate_code(J_id, "yl012_J_id", codegen_options);
  mecali::generate_code(J_s, "yl012_J_s", codegen_options);
  mecali::generate_code(J_b, "yl012_J_b", codegen_options);
  mecali::generate_code(dJ_s, "yl012_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "yl012_dJ_b", codegen_options);

  robot_model.generate_json("yl012.json");
