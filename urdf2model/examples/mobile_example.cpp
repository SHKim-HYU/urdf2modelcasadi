...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYUMM/mobile.urdf";
  ...
  mecali::generate_code(fd, "mobile_fd", codegen_options);
  mecali::generate_code(id, "mobile_id", codegen_options);
  mecali::generate_code(M, "mobile_M", codegen_options);
  mecali::generate_code(Minv, "mobile_Minv", codegen_options);
  mecali::generate_code(C, "mobile_C", codegen_options);
  mecali::generate_code(G, "mobile_G", codegen_options);
  mecali::generate_code(fk, "mobile_fk", codegen_options);
  mecali::generate_code(J_s, "mobile_J_s", codegen_options);
  mecali::generate_code(J_b, "mobile_J_b", codegen_options);

  robot_model.generate_json("mobile.json");
