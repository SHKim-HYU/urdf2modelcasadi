...
int main()
{
  ...
  mecali::generate_code(fd, "hyumob_fd", codegen_options);
  mecali::generate_code(id, "hyumob_id", codegen_options);
  mecali::generate_code(M, "hyumob_M", codegen_options);
  mecali::generate_code(Minv, "hyumob_Minv", codegen_options);
  mecali::generate_code(C, "hyumob_C", codegen_options);
  mecali::generate_code(G, "hyumob_G", codegen_options);
