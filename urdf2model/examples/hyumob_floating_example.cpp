...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYUMM/hyumob_floating.urdf";
  ...
  mecali::generate_code(C, "hyumob_floating_C", codegen_options);
  mecali::generate_code(G, "hyumob_floating_G", codegen_options);
  mecali::generate_code(fk, "hyumob_floating_fk", codegen_options);
  mecali::generate_code(J_s, "hyumob_floating_J_s", codegen_options);
  mecali::generate_code(J_b, "hyumob_floating_J_b", codegen_options);

  robot_model.generate_json("hyumob_floating.json");
