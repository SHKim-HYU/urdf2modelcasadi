...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/indy7/indy7_floating.urdf";
  ...
  mecali::generate_code(fd, "indy7_floating_fd", codegen_options);
  mecali::generate_code(CoM_x, "indy7_floating_CoM_x", codegen_options);
  mecali::generate_code(id, "indy7_floating_id", codegen_options);
  mecali::generate_code(M, "indy7_floating_M", codegen_options);
  mecali::generate_code(Minv, "indy7_floating_Minv", codegen_options);
  mecali::generate_code(C, "indy7_floating_C", codegen_options);
  mecali::generate_code(G, "indy7_floating_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "indy7_floating_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "indy7_floating_fk_ee", codegen_options);
  mecali::generate_code(fk, "indy7_floating_fk", codegen_options);
  mecali::generate_code(J_fd, "indy7_floating_J_fd", codegen_options);
  mecali::generate_code(J_id, "indy7_floating_J_id", codegen_options);
  mecali::generate_code(J_s, "indy7_floating_J_s", codegen_options);
  mecali::generate_code(J_b, "indy7_floating_J_b", codegen_options);
  mecali::generate_code(dJ_s, "indy7_floating_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "indy7_floating_dJ_b", codegen_options);

  robot_model.generate_json("indy7_floating.json");
