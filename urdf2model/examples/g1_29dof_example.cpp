...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/Unitree/g1/g1_29dof.urdf";
  ...
  std::vector<std::string> required_Frames = {"pelvis_contour_joint", "left_hand_palm_joint", "right_hand_palm_joint"};
  std::string left_hand_name = "left_hand_palm_joint";
  std::string right_hand_name = "right_hand_palm_joint";
  std::string pelvis_name = "pelvis_contour_joint";

  casadi::Function fk_lh = robot_model.forward_kinematics("transformation", left_hand_name);
  casadi::Function fk_rh = robot_model.forward_kinematics("transformation", right_hand_name);
  casadi::Function fk_pv = robot_model.forward_kinematics("transformation", pelvis_name);
  ...
  casadi::Function J_s = robot_model.kinematic_jacobian("space", left_hand_name);
  casadi::Function J_b = robot_model.kinematic_jacobian("body", left_hand_name);

  casadi::Function dJ_s = robot_model.jacobian_derivative("space", left_hand_name);
  casadi::Function dJ_b = robot_model.jacobian_derivative("body", left_hand_name);
  ...
  mecali::generate_code(fd, "g1_29dof_fd", codegen_options);
  mecali::generate_code(CoM_x, "g1_29dof_CoM_x", codegen_options);
  mecali::generate_code(J_com, "g1_29dof_J_com", codegen_options);
  mecali::generate_code(id, "g1_29dof_id", codegen_options);
  mecali::generate_code(M, "g1_29dof_M", codegen_options);
  mecali::generate_code(Minv, "g1_29dof_Minv", codegen_options);
  mecali::generate_code(C, "g1_29dof_C", codegen_options);
  mecali::generate_code(G, "g1_29dof_G", codegen_options);
  mecali::generate_code(fk_lh, "g1_29dof_fk_lh", codegen_options);
  mecali::generate_code(fk_rh, "g1_29dof_fk_rh", codegen_options);
  mecali::generate_code(fk_pv, "g1_29dof_fk_pv", codegen_options);
  mecali::generate_code(fk, "g1_29dof_fk", codegen_options);
  mecali::generate_code(J_fd, "g1_29dof_J_fd", codegen_options);
  mecali::generate_code(J_id, "g1_29dof_J_id", codegen_options);
  mecali::generate_code(J_s, "g1_29dof_J_s", codegen_options);
  mecali::generate_code(J_b, "g1_29dof_J_b", codegen_options);
  mecali::generate_code(dJ_s, "g1_29dof_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "g1_29dof_dJ_b", codegen_options);

  robot_model.generate_json("g1_29dof.json");
