...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYU/caesar/KARM_EM_v2.urdf";
  ...
  robot_model.rotorInertia << 3.636e-4, 3.636e-4, 3.636e-4, 3.636e-4, 3.636e-4, 3.636e-4, 3.636e-4;  // Rotor+Wave generator inertia
  ...
  mecali::generate_code(fd, "KARM_EM_v2_fd", codegen_options);
  mecali::generate_code(id, "KARM_EM_v2_id", codegen_options);
  mecali::generate_code(M, "KARM_EM_v2_M", codegen_options);
  mecali::generate_code(Minv, "KARM_EM_v2_Minv", codegen_options);
  mecali::generate_code(C, "KARM_EM_v2_C", codegen_options);
  mecali::generate_code(G, "KARM_EM_v2_G", codegen_options);

  mecali::generate_code(fkrot_ee, "KARM_EM_v2_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "KARM_EM_v2_fk_ee", codegen_options);
  mecali::generate_code(fk, "KARM_EM_v2_fk", codegen_options);
  mecali::generate_code(J_fd, "KARM_EM_v2_J_fd", codegen_options);
  mecali::generate_code(J_id, "KARM_EM_v2_J_id", codegen_options);
  mecali::generate_code(J_s, "KARM_EM_v2_J_s", codegen_options);
  mecali::generate_code(J_b, "KARM_EM_v2_J_b", codegen_options);
  mecali::generate_code(dJ_s, "KARM_EM_v2_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "KARM_EM_v2_dJ_b", codegen_options);

  robot_model.generate_json("KARM_EM_v2.json");
