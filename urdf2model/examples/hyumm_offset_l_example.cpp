...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYUMM/hyumm_offset_l.urdf";
  ...
  mecali::generate_code(fd, "hyumm_offset_l_fd", codegen_options);
  mecali::generate_code(CoM_x, "hyumm_offset_l_CoM_x", codegen_options);
  mecali::generate_code(J_com, "hyumm_offset_l_J_com", codegen_options);
  mecali::generate_code(id, "hyumm_offset_l_id", codegen_options);
  mecali::generate_code(M, "hyumm_offset_l_M", codegen_options);
  mecali::generate_code(Minv, "hyumm_offset_l_Minv", codegen_options);
  mecali::generate_code(C, "hyumm_offset_l_C", codegen_options);
  mecali::generate_code(G, "hyumm_offset_l_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
  mecali::generate_code(fkrot_ee, "hyumm_offset_l_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "hyumm_offset_l_fk_ee", codegen_options);
  mecali::generate_code(fk_base, "hyumm_offset_l_fk_base", codegen_options);
  mecali::generate_code(fk, "hyumm_offset_l_fk", codegen_options);
  mecali::generate_code(J_fd, "hyumm_offset_l_J_fd", codegen_options);
  mecali::generate_code(J_id, "hyumm_offset_l_J_id", codegen_options);
  mecali::generate_code(J_s, "hyumm_offset_l_J_s", codegen_options);
  mecali::generate_code(J_b, "hyumm_offset_l_J_b", codegen_options);
  mecali::generate_code(dJ_s, "hyumm_offset_l_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "hyumm_offset_l_dJ_b", codegen_options);

  robot_model.generate_json("hyumm_offset_l.json");
