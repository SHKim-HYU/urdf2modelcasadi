...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYUSPA/hyu_spa.urdf";
  ...
  mecali::generate_code(fd, "hyu_spa_fd", codegen_options);
  mecali::generate_code(CoM_x, "hyu_spa_CoM_x", codegen_options);
  mecali::generate_code(id, "hyu_spa_id", codegen_options);
  mecali::generate_code(M, "hyu_spa_M", codegen_options);
  mecali::generate_code(Minv, "hyu_spa_Minv", codegen_options);
  mecali::generate_code(C, "hyu_spa_C", codegen_options);
  mecali::generate_code(G, "hyu_spa_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "hyu_spa_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "hyu_spa_fk_ee", codegen_options);
  mecali::generate_code(fk, "hyu_spa_fk", codegen_options);
  mecali::generate_code(J_fd, "hyu_spa_J_fd", codegen_options);
  mecali::generate_code(J_id, "hyu_spa_J_id", codegen_options);
  mecali::generate_code(J_s, "hyu_spa_J_s", codegen_options);
  mecali::generate_code(J_b, "hyu_spa_J_b", codegen_options);
  mecali::generate_code(dJ_s, "hyu_spa_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "hyu_spa_dJ_b", codegen_options);

  robot_model.generate_json("hyu_spa.json");
