...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/HYUMM/hyumob_offset_l.urdf";
  ...
  std::vector<std::string> required_Frames = {"base_link"};
  ...
  mecali::generate_code(fd, "hyumob_offset_l_fd", codegen_options);
  mecali::generate_code(id, "hyumob_offset_l_id", codegen_options);
  mecali::generate_code(M, "hyumob_offset_l_M", codegen_options);
  mecali::generate_code(Minv, "hyumob_offset_l_Minv", codegen_options);
  mecali::generate_code(C, "hyumob_offset_l_C", codegen_options);
  mecali::generate_code(G, "hyumob_offset_l_G", codegen_options);
  mecali::generate_code(fk, "hyumob_offset_l_fk", codegen_options);
  mecali::generate_code(J_s, "hyumob_offset_l_J_s", codegen_options);
  mecali::generate_code(J_b, "hyumob_offset_l_J_b", codegen_options);

  robot_model.generate_json("hyumob_offset_l_.json");
