...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/kuka_kr250/kuka_kr_250.urdf";
  ...
  mecali::generate_code(fd, "kuka_kr_250_fd", codegen_options);
  mecali::generate_code(id, "kuka_kr_250_id", codegen_options);
  mecali::generate_code(M, "kuka_kr_250_M", codegen_options);
  mecali::generate_code(Minv, "kuka_kr_250_Minv", codegen_options);
  mecali::generate_code(C, "kuka_kr_250_C", codegen_options);
  mecali::generate_code(G, "kuka_kr_250_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "kuka_kr_250_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "kuka_kr_250_fk_ee", codegen_options);
  mecali::generate_code(fk, "kuka_kr_250_fk", codegen_options);
  mecali::generate_code(J_s, "kuka_kr_250_J_s", codegen_options);
  mecali::generate_code(J_b, "kuka_kr_250_J_b", codegen_options);

  robot_model.generate_json("kuka_kr_250.json");
