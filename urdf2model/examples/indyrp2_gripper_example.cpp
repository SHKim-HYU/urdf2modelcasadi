...
int main()
{
  ...
  // ---------------------------------------------------------------------
  // std::string urdf_filename = ws_path+"/urdf2model/models/NRMK/indyrp2/indyrp2.urdf";
  std::string urdf_filename = ws_path+"/urdf2model/models/NRMK/indyrp2_gripper/indyrp2_gripper.urdf";
  // Instantiate a Serial_Robot object called robot_model
  mecali::Serial_Robot robot_model;
  // Define (optinal) gravity vector to be used
  Eigen::Vector3d gravity_vector(0, 0, -9.80665);
  ...
  mecali::generate_code(fd, "indyrp2_gripper_fd", codegen_options);
  mecali::generate_code(id, "indyrp2_gripper_id", codegen_options);
  mecali::generate_code(M, "indyrp2_gripper_M", codegen_options);
  mecali::generate_code(Minv, "indyrp2_gripper_Minv", codegen_options);
  mecali::generate_code(C, "indyrp2_gripper_C", codegen_options);
  mecali::generate_code(G, "indyrp2_gripper_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "indyrp2_gripper_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "indyrp2_gripper_fk_ee", codegen_options);
  mecali::generate_code(fk, "indyrp2_gripper_fk", codegen_options);
  mecali::generate_code(J_fd, "indyrp2_gripper_J_fd", codegen_options);
  mecali::generate_code(J_id, "indyrp2_gripper_J_id", codegen_options);
  mecali::generate_code(J_s, "indyrp2_gripper_J_s", codegen_options);
  mecali::generate_code(J_b, "indyrp2_gripper_J_b", codegen_options);
  mecali::generate_code(dJ_s, "indyrp2_gripper_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "indyrp2_gripper_dJ_b", codegen_options);

  robot_model.generate_json("indyrp2_gripper.json");
