...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/NRMK/indy7/indy7_v2.urdf";
  ...
  mecali::generate_code(fd, "indy7_v2_fd", codegen_options);
  mecali::generate_code(id, "indy7_v2_id", codegen_options);
  mecali::generate_code(M, "indy7_v2_M", codegen_options);
  mecali::generate_code(Minv, "indy7_v2_Minv", codegen_options);
  mecali::generate_code(C, "indy7_v2_C", codegen_options);
  mecali::generate_code(G, "indy7_v2_G", codegen_options);
   mecali::generate_code(fkrot_ee, "indy7_v2_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "indy7_v2_fk_ee", codegen_options);
