...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/space_arm/space_arm_base.urdf";
  ...
  mecali::generate_code(fd, "space_arm_base_fd", codegen_options);
  mecali::generate_code(CoM_x, "space_arm_base_CoM_x", codegen_options);
  mecali::generate_code(J_com, "space_arm_base_J_com", codegen_options);
  mecali::generate_code(id, "space_arm_base_id", codegen_options);
  mecali::generate_code(M, "space_arm_base_M", codegen_options);
  mecali::generate_code(Minv, "space_arm_base_Minv", codegen_options);
  mecali::generate_code(C, "space_arm_base_C", codegen_options);
  mecali::generate_code(G, "space_arm_base_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "space_arm_base_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "space_arm_base_fk_ee", codegen_options);
  mecali::generate_code(fk, "space_arm_base_fk", codegen_options);
  mecali::generate_code(J_fd, "space_arm_base_J_fd", codegen_options);
  mecali::generate_code(J_id, "space_arm_base_J_id", codegen_options);
  mecali::generate_code(J_s, "space_arm_base_J_s", codegen_options);
  mecali::generate_code(J_b, "space_arm_base_J_b", codegen_options);
  mecali::generate_code(dJ_s, "space_arm_base_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "space_arm_base_dJ_b", codegen_options);

  robot_model.generate_json("space_arm_base.json");
