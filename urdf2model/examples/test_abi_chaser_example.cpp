...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/test_abi/chaser_virtual.urdf";
  ...
  std::vector<std::string> required_Frames = {"VirtualJoint_p1", "VirtualJoint_p2", "VirtualJoint_p3", "VirtualJoint_r1", "VirtualJoint_r2", "VirtualJoint_r3", "Joint1", "Joint2", "Joint3", "Joint4", "Joint5", "Joint6", "Joint7", "tcp_joint"};
  ...
  mecali::generate_code(fd, "chaser_fd", codegen_options);
  mecali::generate_code(CoM_x, "chaser_CoM_x", codegen_options);
  mecali::generate_code(J_com, "chaser_J_com", codegen_options);
  mecali::generate_code(id, "chaser_id", codegen_options);
  mecali::generate_code(M, "chaser_M", codegen_options);
  mecali::generate_code(Minv, "chaser_Minv", codegen_options);
  mecali::generate_code(C, "chaser_C", codegen_options);
  mecali::generate_code(G, "chaser_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "chaser_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "chaser_fk_ee", codegen_options);
  mecali::generate_code(fk, "chaser_fk", codegen_options);
  mecali::generate_code(J_fd, "chaser_J_fd", codegen_options);
  mecali::generate_code(J_id, "chaser_J_id", codegen_options);
  mecali::generate_code(J_s, "chaser_J_s", codegen_options);
  mecali::generate_code(J_b, "chaser_J_b", codegen_options);
  mecali::generate_code(dJ_s, "chaser_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "chaser_dJ_b", codegen_options);

  robot_model.generate_json("chaser.json");
