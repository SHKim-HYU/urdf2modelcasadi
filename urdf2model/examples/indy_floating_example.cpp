...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/dyn/indy_floating.urdf";
  ...
  mecali::generate_code(fd, "indy_floating_fd", codegen_options);
  mecali::generate_code(CoM_x, "indy_floating_CoM_x", codegen_options);
  mecali::generate_code(id, "indy_floating_id", codegen_options);
  mecali::generate_code(M, "indy_floating_M", codegen_options);
  mecali::generate_code(Minv, "indy_floating_Minv", codegen_options);
  mecali::generate_code(C, "indy_floating_C", codegen_options);
  mecali::generate_code(G, "indy_floating_G", codegen_options);
   mecali::generate_code(fkrot_ee, "indy_floating_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "indy_floating_fk_ee", codegen_options);
  mecali::generate_code(fk, "indy_floating_fk", codegen_options);
  mecali::generate_code(J_fd, "indy_floating_J_fd", codegen_options);
  mecali::generate_code(J_id, "indy_floating_J_id", codegen_options);
  mecali::generate_code(J_s, "indy_floating_J_s", codegen_options);
  mecali::generate_code(J_b, "indy_floating_J_b", codegen_options);
  mecali::generate_code(dJ_s, "indy_floating_dJ_s", codegen_options);
  mecali::generate_code(dJ_b, "indy_floating_dJ_b", codegen_options);

  robot_model.generate_json("indy_floating.json");
